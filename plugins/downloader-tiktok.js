...
try {
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: `${wm}`, body: null, thumbnail: imagen1, sourceUrl: `${wm}` }, mentionedJid: [m.sender] }}}, { quoted: m })

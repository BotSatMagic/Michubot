...
let fakegif = { key: {participant: `0@s.whatsapp.net`, ...("000000@g.us" ? { remoteJid: "00000@g.us" } : {})},message: {"videoMessage": { "title": `${wm}`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `${wm}`, 'jpegThumbnail': false }}}
